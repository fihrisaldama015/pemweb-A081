...
PHP.";
$social= array(
  array("link"=>"https://www.instagram.com/muhamadfihris/", "icon"=>"./pngkey.com-instagram-png-775860.png"),
  array("link"=>"https://github.com/fihrisaldama015/","icon"=>"./github.png")
);
$sertif=array(
  array("judul"=>"Git Fundamental", "company"=>"Progate", "link"=>"https://progate.com/course_certificate/ddc975f1qzfeep", "url"=>"./progate.jpeg"),
  array("judul"=>"Belajar Membuat Font-End Web untuk Pemula", "company"=>"Dicoding Indonesia", "link"=>"https://www.dicoding.com/certificates/6RPNDN6D5Z2M", "url"=>"./dicoding.jpeg")
);
    ...
    <div class="about">
      <div class="card">
        ...
        <div class="container-sertif">
          <?php foreach($sertif as $data): ?>
          <div class="sertif">
            <img src="<?= $data['url']?>" alt="progate" />
